...
const getLinksFromFile = (e) => {
  ...
  if (lb.areThereLinks(content)) {
    ...
    result = lb.listofLinks(filelinks, e, content);
  }
  return result;
};

// console.log(getLinksFromFile('/Users/Drive/Documents/LABORAToRIa/LIM012-fe-md-links/links/testLinks01.md'));
...
// Directory
// mdLinks('../links/', { validate: true }).then((val) => console.log(val));
